            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-8 col-md-6 d-flex flex-column justify-content-center text-center text-md-left">
                        <!-- start page title -->
                        <h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin-bottom text-uppercase">This is a standard post with a preview image</h1>
                        <!-- end page title -->
                    </div>
                ...
                <div class="row">
                    <main class="col-12 col-lg-9 right-sidebar md-margin-60px-bottom sm-margin-40px-bottom pl-0 md-no-padding-right">
                        <div class="col-12 blog-details-text last-paragraph-no-margin">
                            <img src="images/blog-details-img19.jpg" alt="" class="width-100 margin-45px-bottom">
                            ...
                            <img src="images/blog-details-img20.jpg" alt="" class="width-100 margin-45px-bottom">
                            <!-- dropcaps -->
                            ...
                            <!-- end dropcaps -->
                            <figure class="wp-caption alignleft"><img alt="" src="images/blog-details-img21.jpg"><figcaption class="wp-caption-text">There is no sincerer love than the love of food.</figcaption></figure>
...
<div class="col-12 blog-details-comments">
                            ...
                            <ul class="blog-comment">
                                <li>
                                    <div class="d-block d-md-flex  width-100">
                                        <div class="width-110px sm-width-50px text-center sm-margin-10px-bottom">
                                            <img src="images/avtar-02.jpg" class="rounded-circle width-85 sm-width-100" alt=""/>
                                        </div>
                                    ...
                                    <ul class="child-comment">
                                        <li>
                                            <div class="d-block d-md-flex  width-100">
                                                <div class="width-110px sm-width-50px text-center sm-margin-10px-bottom">
                                                    <img src="images/avtar-01.jpg" class="rounded-circle width-85 sm-width-100" alt="" />
                                                </div>
                                                <div class="width-100 padding-40px-left last-paragraph-no-margin sm-no-padding-left">
                                ...
                                <li>
                                    <div class="d-block d-md-flex  width-100">
                                        <div class="width-110px sm-width-50px text-center sm-margin-10px-bottom">
                                            <img src="images/avtar-04.jpg" class="rounded-circle width-85 sm-width-100" alt=""/>
                                        </div>
                                        <div class="width-100 padding-40px-left last-paragraph-no-margin sm-no-padding-left">
