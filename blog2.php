            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 d-flex flex-column justify-content-center text-center extra-small-screen page-title-large">
                        <!-- start page title -->
                        <h1 class="text-white-2 alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom">Blog Name</h1>
                        <span class="text-white-2 opacity6 alt-font">Blog discr</span>
                        <!-- end page title --> 
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-8 col-md-6 d-flex flex-column justify-content-center text-center text-md-left">
                        <!-- start page title -->
                        <h1 class="alt-font text-extra-dark-gray font-weight-600 mb-0 text-uppercase">Image blog</h1>
                        <!-- end page title -->
                    </div>
                    <div class="col-xl-4 col-md-6 alt-font breadcrumb justify-content-center justify-content-md-end text-small sm-margin-10px-top">
                        <!-- start breadcrumb -->
                        <ul class="text-center text-md-left text-uppercase">
                            <li><a href="#" class="text-dark-gray">25 April 2019</a></li>
                            <li><span class="text-dark-gray">by <a href="blog-masonry.html">Karthik Veer</a></span></li>
                    ...
                    <main class="col-12 col-lg-12 right-sidebar md-margin-60px-bottom sm-margin-40px-bottom pl-0 md-no-padding-right">
                        <div class="col-12 blog-details-text last-paragraph-no-margin">
                            <div class="blog-post-content margin-45px-bottom sm-margin-30px-bottom text-center text-md-left">
                                ...
                                <img src="images/testimage.jpg" alt="" class="width-100 margin-45px-bottom">
                                    <!-- start video -->
