...
<!-- End Facebook Pixel Code -->
    ...
    <section class="p-0 wow fadeIn bg-gray" id="services">
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-12 col-lg-6 position-md-left md-height-550px sm-height-350px cover-background wow slideInLeft" data-wow-duration="900ms" style="background-image: url('images/karthikveer.jpg');"></div>
                    ...
                    <div>
                        ...
                        <form id="project-contact-form" action="javascript:void(0)" method="post">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <textarea name="message" id="message" placeholder="Enter your Message" rows="2" class="big-textarea   border-color-medium-dark-gray  "></textarea>
                                </div>
