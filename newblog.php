                    ...
                    <div class="col-12 px-3 p-md-0">
                        <ul class="blog-grid blog-4col gutter-small">
                            ...
                            <li class="grid-item wow fadeInUp" data-wow-delay="0.2s">
                                <figure>
                                    <div class="blog-img bg-extra-dark-gray">
                                        <a href="blog-post-layout-05.html"><img src="images/blog-page-03-img5.jpg" alt="" ></a>
                                    </div>
                                    <figcaption>
                                        <div class="portfolio-hover-main text-left">
                                            <div class="blog-hover-box align-bottom">
                            ...
                            <li class="grid-item wow fadeInUp" data-wow-delay="0.4s">
                                <figure>
                                    <div class="blog-img bg-extra-dark-gray">
                                        <a href="blog-post-layout-02.html"><img src="images/blog-page-03-img5.jpg" alt="" ></a>
                                    </div>
                                    <figcaption>
                                        <div class="portfolio-hover-main text-left">
                                            <div class="blog-hover-box align-bottom">
                            ...
                            <li class="grid-item wow fadeInUp">
                                <figure>
                                    <div class="blog-img bg-extra-dark-gray">
                                        <a href="blog-post-layout-04.html"><img src="images/blog-page-03-img5.jpg" alt="" ></a>
                                    </div>
                                    <figcaption>
                                        <div class="portfolio-hover-main text-left">
                                            <div class="blog-hover-box align-bottom">
                                    ...
                                    <figcaption>
                                        <div class="portfolio-hover-main text-left">
                                            <div class="blog-hover-box align-bottom">
                                                ...
                                                <p class="text-medium-white margin-10px-top width-80 md-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            </div>
                                        </div>
                                    </figcaption>
                                </figure>
