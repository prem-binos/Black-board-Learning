...
<html class="no-js" lang="en">
    <head>
        <!-- title -->
        <title>Turings- a paltform for your machine learning skills</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <!-- end header -->
        <!-- start hero section -->
        <section id="home" class="p-0 parallax mobile-height wow fadeIn" data-stellar-background-ratio="0.5" style="background-image:url('images/homepage-9-slider-img-1.jpg');">
        ...
        <section class="parallax wow fadeIn" data-stellar-background-ratio="0.3" style="background-image:url('images/homepage-9-parallax-img2.jpg');">
        ...
        <!-- start parallax section -->
        <section class="parallax wow fadeIn " data-stellar-background-ratio="0.6" style="background-image:url('images/homepage-9-parallax-img5.jpg');">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 md-margin-four-bottom sm-margin-30px-bottom text-center sm-margin-twelve-bottom wow fadeInRight last-paragraph-no-margin">
                        <img src="images/avtar-01.jpg" class="rounded-circle width-30 sm-width-100px sm-margin-15px-bottom margin-30px-bottom" alt=""/>
                    ...
                    <div class="col-12 col-md-4 md-margin-four-bottom sm-margin-30px-bottom text-center sm-margin-twelve-bottom wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.2s">
                        <img src="images/avtar-02.jpg" class="rounded-circle width-30 sm-width-100px sm-margin-15px-bottom margin-30px-bottom" alt=""/>
                    ...
                    <div class="col-12 col-md-4 md-margin-four-bottom sm-margin-30px-bottom text-center wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.4s">
                        <img src="images/avtar-03.jpg" class="rounded-circle width-30 sm-width-100px sm-margin-15px-bottom margin-30px-bottom" alt=""/>
        ...
        <section id="contact" class="wow fadeIn p-0 bg-extra-dark-gray">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-6 cover-background md-height-550px sm-height-350px wow fadeIn" style="background: url(images/homepage-9-parallax-img6.jpg)"></div>
