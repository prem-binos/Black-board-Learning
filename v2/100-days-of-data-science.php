...
<!-- End Facebook Pixel Code -->
    <head>
        ...
        <title>100 Days of Data Science | Black Board Learning</title>
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 d-flex flex-column justify-content-center text-center extra-small-screen page-title-large"style="height: 440px;">
                        <!-- start page title -->
                        <h1 class="text-white-2 alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom"style="color:#ffffff">100 Days of Data Science</h1>
