...
<script>
  ...
  gtag('config', 'UA-99823617-1');
    ...
    <body>
        ...
        <section class="wow fadeIn parallax" data-stellar-background-ratio="0.5" style="background-image:url('images/blog1.jpg');">
            <div class="opacity-medium bg-extra-dark-gray"></div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 d-flex flex-column justify-content-center text-center one-second-screen page-title-large">
                        <!-- start page title -->
                        <h1 class="text-white alt-font font-weight-600 margin-10px-bottom">This is the secret of success</h1>
                        <!-- end page title -->
                        <!-- start sub title -->
                        <span class="text-white opacity6 alt-font no-margin-bottom text-uppercase text-small">25 April 2017&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;by <a href="blog-masonry.html" class="text-white">Jay Benjamin</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="blog-masonry.html" class="text-white">Design</a>, <a href="blog-masonry.html" class="text-white-2">Branding</a></span>
                        <!-- end sub title -->
                    </div>
                </div>
            </div>
        ...
        <!--<section class="wow fadeIn p-0 parallax one-fourth-screen md-height-500px sm-height-350px background-position-x-50" data-stellar-background-ratio="0.5" style="background-image: url('images/blog2.jpg')">
            <div class="container">
                <div class="row">
        ...
        <section class="wow fadeIn">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-10 mx-auto text-left text-md-left">
                        <h5 class="font-weight-600 text-black alt-font">The best and most beautiful things in the world cannot be seen or even touched - they must be felt with the heart.</h5>
                    ...
                    <div class="col-12 col-lg-10 mx-auto text-left text-md-left">
                        <img class="alignleft" src="images/bl1.jpg" alt="">
                ...
                <div class="row">
                    <div class="col-12 col-lg-10 mx-auto wow fadeInUp">
                        <div class=" bg-light-gray padding-50px-all sm-padding-30px-all">
                            <p class="text-large m-0"><span class="first-letter first-letter-block bg-extra-dark-gray text-white-2">T</span>oday I choose life. Every morning when I wake up I can choose joy, happiness, negativity, pain. To feel the freedom that comes from being able to continue to make mistakes and choices today I choose to feel life, not to deny my humanity but embrace it.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6 last-paragraph-no-margin text-center text-md-left wow fadeInUp">
                        <h5 class="font-weight-600 text-black alt-font">Throw your dreams into space like a kite, and you do not know what it will bring back, a new life, a new friend, a new love, a new country.</h5>
                    </div>
                    <div class="col-12 col-lg-5 offset-lg-1 text-center text-md-left last-paragraph-no-margin wow fadeInUp" data-wow-delay="0.2s">
                        <p>Koordinaten bilden die Grundlage f�r Einsatz des Produktes ausgerichtete Corporate Design. Reale Daten wie zum Beispiel Wetterdaten, Geografische Fl�chen und H�henmeter, werden in das Design in mit einbezogen. Die neu gestaltete Marke zeichnet sich sowohl durch userorientierte Einsatz. die in Grundlage f�r das Einsatz von des Produktes ausgerichtete Corporate Voin Design. in Reale Daten wie zum Beispiel Wetterdaten, Geog rafische Koordi naten und H�henmeter.</p>
                    </div>
                </div>
            </div>
        </section>
          <div class="separator-line-horrizontal-full bg-extra-light-gray margin-60px-top height-6px width-20 mx-auto"></div>
        <!-- end section -->
        <!-- start parallax section -->
         <!-- <section class="wow fadeIn p-0 parallax one-fourth-screen md-height-500px sm-height-350px background-position-x-50" data-stellar-background-ratio="0.5" style="background-image: url('images/blog1.jpg')">
            <div class="container">
                <div class="row">
                    <div class="col-12"></div>
                </div>
                    ...
                    <div class="col-12 col-lg-10 mx-auto margin-50px-top md-margin-30px-top wow fadeInUp">
                        <div class="d-block d-md-flex width-100 align-items-center align-items-md-start width-100 border border-color-extra-light-gray padding-50px-all md-padding-30px-all sm-padding-20px-all">
                            <div class="width-150px sm-margin-15px-bottom sm-width-100 text-center">
                                <img src="images/avtar-01.jpg" class="rounded-circle width-100px" alt=""/>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp">
                        <div class="blog-post blog-post-style1 text-center text-md-left">
                            ...
                            <div class="post-details">
                                <span class="post-author text-extra-small text-medium-black text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">17 july 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                <a href="blog-post-layout-01.html" class="post-title text-medium text-black width-90 d-block md-width-100">I try to look at design from a more conceptual standpoint.</a>
                    ...
                    <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-post blog-post-style1 text-center text-md-left">
                            ...
                            <div class="post-details">
                                <span class="post-author text-extra-small text-medium-black text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">03 July 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Herman Miller</a></span>
                                <a href="blog-post-layout-02.html" class="post-title text-medium text-black width-90 d-block md-width-100">Good design accelerates the adoption of new ideas.</a>
                                <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb md-margin-15px-tb"></div> 
                                <p class="width-90 sm-width-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-post blog-post-style1 text-center text-md-left">
                            ...
                            <div class="post-details">
                                <span class="post-author text-extra-small text-medium-black text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">22 June 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Hugh Macleod</a></span>
                                <a href="blog-post-layout-03.html" class="post-title text-medium text-black width-90 d-block md-width-100">Design is inherently optimistic. That is its power.</a>
                                <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb md-margin-15px-tb"></div>
                                <p class="width-90 sm-width-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-post blog-post-style1 text-center text-md-left">
                            ...
                            <div class="post-details">
                                <span class="post-author text-extra-small text-medium-black text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">02 June 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jennifer Freeman</a></span>
                                <a href="blog-post-layout-04.html" class="post-title text-medium text-black width-90 d-block md-width-100">I wish someone would ask me to design a cathedral.</a>
                                <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb md-margin-15px-tb"></div>
                                <p class="width-90 sm-width-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                            </div>
                        </div>
