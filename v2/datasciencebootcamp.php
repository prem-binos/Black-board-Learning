...
<script>
  ...
  gtag('config', 'UA-99823617-1');
    ...
    <body>
        ...
        <section id="home" class="p-0 parallax mobile-height wow fadeIn" data-stellar-background-ratio="0.5" style="background-image: url(&quot;images/course/fullstackinnerbanner.jpg&quot;); visibility: visible; animation-name: fadeIn; background-position: 0px 0px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 offset-lg-2 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                        <ul class="list-style-8 margin-twelve-left">
                            ...
                            <li class="text-extra-dark-gray"><span class="d-block text-extra-large  text-black  font-weight-500 line-height-22">DATE</span><a href="index.html" class="text-large text-extra-dark-gray">29th January 2022 </a></li>
                    ...
                    <div class="col-12 col-md-4 sm-margin-five-bottom last-paragraph-no-margin wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="feature-box">
                            <div class="content">
                                ...
                                <div class="text-medium alt-font text-capitalize text-white margin-10px-bottom md-margin-5px-bottom">Data Visualization – Tableau</div>
                                <p class="width-85 mx-auto md-width-100">All chart types, Filtering, Grouping, calculated field creation ,Dashboard with action, Storyboard.</p>
                            </div>        
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4 sm-margin-five-bottom last-paragraph-no-margin wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        <div class="feature-box">
                            <div class="content">
                                ...
                                <p class="width-85 mx-auto md-width-100">SQl fundamentals, Big data basics with Hadoop, MapR and overview of Apache scoop, Flume.</p>
                            </div>   
                        </div>
                    </div>
                    <!-- end feature box item-->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 sm-margin-five-bottom last-paragraph-no-margin wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="feature-box">
                            <div class="content">
                                <i class="icon-browser text-medium-gray icon-large margin-25px-bottom md-margin-15px-bottom"></i>
                                <div class="text-medium alt-font text-capitalize text-white margin-10px-bottom md-margin-5px-bottom">Data Analytics – R & Python</div>
                                <p class="width-85 mx-auto md-width-100">R basic funstions & packages, R_dplyr, Caret, Lattice, Python - Pandes, Numpy, Scipyu, Matploy lib. </p>
                            </div>        
                        </div>
                    </div>
                    <!-- end feature box item-->
                    ...
                    <div class="col-12 col-md-4 sm-margin-five-bottom last-paragraph-no-margin wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="feature-box">
                            <div class="content">
                                <i class="icon-book-open text-medium-gray icon-large margin-25px-bottom md-margin-15px-bottom"></i>
                                <div class="text-medium alt-font text-capitalize text-white margin-10px-bottom md-margin-5px-bottom">Machine Learning - R & Python</div>
                                <p class="width-85 mx-auto md-width-100">Linear & Logistic regression, support vendor machines, Decision trees, Random forest, Gradient boosting, K-Nearest Neighbors.
                    ...
                    <div class="col-12 col-md-4 sm-margin-five-bottom last-paragraph-no-margin wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        <div class="feature-box">
                            <div class="content">
                                ...
                                <p class="width-85 mx-auto md-width-100">Treating missing values with MICE / Amelia, outlier values treatment with different techniques.
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 d-flex align-items-center justify-content-center p-0 cover-background position-relative wow fadeIn md-height-400px sm-height-200px" style="background: url(&quot;images/parallax-bg9.jpg&quot;); visibility: visible; animation-name: fadeIn;">
                        ...
                        <div class="position-relative padding-twelve-all text-center text-lg-left md-padding-five-all md-width-70 sm-width-90">
                            <h5 class="alt-font text-white-2 width-75 margin-20px-bottom lg-width-100 md-margin-15px-bottom">Interest free EMIs available</h5>
                    ...
                    <div class="col-12 col-lg-4 d-flex align-items-center justify-content-center p-0 cover-background position-relative wow fadeIn md-height-400px sm-height-200px" style="background: url(&quot;images/digital-marketing.jpg&quot;); visibility: visible; animation-name: fadeIn;">
                        ...
                        <div class="position-relative text-center">
                               <h5 class="alt-font text-white  margin-20px-bottom lg-width-100 md-margin-15px-bottom"><b><span class="text-extra-dark-gray">COURSE PRICE</span></br>Rs.33,500</b></h5>
                        </div>
                    </div>
                    <!-- end box item -->
                    <!-- start box item -->
                    <div class="col-12 col-lg-4 d-flex align-items-center justify-content-center p-0 cover-background position-relative wow fadeIn md-height-400px sm-height-200px" style="background: url(&quot;images/parallax-bg10.jpg&quot;); visibility: visible; animation-name: fadeIn;">
                        ...
                        <div class="position-relative padding-twelve-all text-center text-lg-left md-padding-five-all md-width-70 sm-width-90">
                            ...
                            <h5 class="alt-font text-white-2 width-75 margin-20px-bottom lg-width-100 md-margin-15px-bottom">Next Batch from 30th April 2022</h5>
                            <a class="btn btn-white btn-very-small" href="accordions.html">Call now</a> 
                        </div>
                    </div>
                    <!-- end box item -->
