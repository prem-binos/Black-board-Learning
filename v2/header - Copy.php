...
<script type="text/javascript" id="zsiqchat">var $zoho=$zoho || {};$zoho.salesiq = $zoho.salesiq || {widgetcode: "ea86f409eab8b83a4be6139723c85f838fffe1d16aa61462ed5e5c37223de59db6d299ef8bf4ed53941a79a415a8ef3b", values:{},ready:function(){}};var d=document;s=d.createElement("script");s.type="text/javascript";s.id="zsiqscript";s.defer=true;s.src="https://salesiq.zoho.com/widget";t=d.getElementsByTagName("script")[0];t.parentNode.insertBefore(s,t);</script>
    ...
    <!-- start navigation -->
    <nav class="navbar navbar-default bootsnav navbar-fixed-top header-dark background-transparent white-link navbar-expand-lg on no-full alter-head" style="    padding: 5px !important;">
        <div class="container nav-header-container">
            <!-- start logo -->
            <div class="col-auto pl-lg-0">
                <a href="index.php" title="Black Board Learning" class="logo"><img style="height: 50px !important;padding-top: 3px;" src="images/bbheader.png" alt="Black Board Learning Logo" class="logo-light default"></a>
            </div>
            <!-- end logo -->
                    ...
                    <ul id="accordion" class="nav navbar-nav no-margin alt-font text-normal">
                     <li class="dropdown simple-dropdown"><a class="fonarto" style="font-size: 18px;" href="#" title="Courses">Courses</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                        ...
                        <li class="dropdown megamenu-fw">
                           <!-- <a href="#" class="fonarto" style="font-size: 18px;" >why us</a> -->
                        </li>
                        <li class="dropdown megamenu-fw">
                           <!-- <a href="blog.php" style="font-size: 18px;" class="fonarto"   >FREE RESOURCES</a>-->
                        </li>
                        <!-- end menu item --><!-- start menu item -->
                        <li class="dropdown megamenu-fw">
                            <a href="contact.php"title="Contact" class="fonarto" style="font-size: 18px;">Contact</a>
                        </li>
                        <li class="dropdown megamenu-fw">
                            <a href="blog.php"title="Blog" class="fonarto" style="font-size: 18px;">Blog</a>
                        </li>
                        <li class="dropdown simple-dropdown"><a class="fonarto" style="font-size: 18px;" href="resources.php" title="Resources">Resources</a>
                        </li>
            ...
            <div class="col-auto pr-lg-0">
                ...
                <div class="header-social-icon d-none d-md-inline-block">
                    <a href="https://www.facebook.com/Black-Board-Learning-1326685824028980/" title="Facebook" target="_blank"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                    <a href="https://www.instagram.com/blackboardlearning/" title="Facebook" target="_blank"><i class="fab fa-instagram"></i></a>
                    <a href="https://www.youtube.com/channel/UCmlkKB1yj_FwR-Fk66GM8TQ?view_as=subscriber" title="Youtube" target="_blank"><i class="fab fa-youtube"></i></a>
...
<script>
  ...
  fbq('init', '3095577793800632');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=3095577793800632&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
<!-- Global site tag (gtag.js) - Google Ads: 715381575 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-715381575"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-715381575');
</script>

<script>
  gtag('config', 'AW-715381575/8M7PCIGu8owDEMe2j9UC', {
    'phone_conversion_number': '8248984562'
  });
</script>
...
<div class="buy-theme alt-font"><a href="tel:8248984562" target="_blank"><i class="fas fa-phone rotate"></i><span>Call US !</span></a></div>
<div class="all-demo alt-font"><a href="index.php#contact" target="_blank"><i class="far fa-envelope" style="    border: 1px solid; padding: 5px 5px;border-radius: 50px;"></i><span>For Enquiry !</span></a></div>
