...
<!-- End Facebook Pixel Code -->
    <head>
        ...
        <title>Learn With Karthik | Black Board Learning</title>
        <meta charset="utf-8">
    ...
    <body>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 d-flex flex-column justify-content-center text-center extra-small-screen page-title-large"style="height: 440px;">
                        <!-- start page title -->
                        <h1 class="text-white-2 alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom"style="color:#ffffff">Learn with Karthik</h1>
        ...
        <section class="col-12 bg-extra-light-gray">
            <div class="container-fluid">
                <h5 class="text-center text-black alt-font font-weight-600 letter-spacing-minus-1">100 Days of Data Science</h5>
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <div class="img-overlay">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/j1IwZlPz-TE?modestbranding=1"frameborder="0" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="img-overlay">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DOxRMOyKK6Y?modestbranding=1"frameborder="0" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-white">
            <div class="container-fluid">
                <h5 class="text-center text-black alt-font font-weight-600 letter-spacing-minus-1">Insights with Karthik</h5>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="img-overlay">
                            <div class="embed-responsive embed-responsive-16by9">
                    ...
                    <div class="col-12 text-center">
                        <a class="btn btn-small btn-dark-gray lg-margin-15px-bottom text-uppercase d-table d-lg-inline-block md-margin-lr-auto" href="https://www.youtube.com/@blackboardlearningcoimbato9409/videos"target="_blank">Watch More</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 margin-eight-bottom text-center last-paragraph-no-margin">
                    <h5 class="alt-font text-black font-weight-600"></h5>
